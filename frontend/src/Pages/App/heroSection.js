  ...
  return (
    <div className="w-[100%] m-auto bg-white">
      <div className="w-[100%] relative overflow-hidden">
        <div className="h-[100%] flex items-center content-center place-content-center w-[10%] absolute top-0 left-0">
          <div
        ...
        <div className="w-[400px] lg:w-[1550px] xl:w-[1550px] h-[140px] lg:h-[450px] xl:h-[450px]  object-cover">
          <img
            src={ImageData[currentIndex].image}
            alt="banner"
            className="w-[550px] lg:w-[100%] xl:w-[100%] h-[140px] lg:h-[450px] xl:h-[450px] object-cover"
          />
        </div>
        <div className="h-[100%] flex items-center content-center place-content-center w-[10%] absolute top-0 right-0">
          <div
            onClick={handleNext}
            className=" w-[50%] flex items-center content-center place-content-center h-[20%] rounded-lg text-primary5  bg-primary4/15 hover:bg-primary4 hover:text-dark mx-auto  "
          >
        ...
        <div className="absolute w-[100%] flex justify-center gap-1 m-auto bottom-2">
